...
public class MenuDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intenta = new Intent(MenuDrawerActivity.this, CiclistaMapsActivity.class);
            ...
            Intent intenta = new Intent(MenuDrawerActivity.this, InformacionReservaActivity.class);
            startActivity(intenta);
            finish();
